...
const buttonClassName = cva(
  'inline-flex items-center justify-center rounded-md font-semibold transition-colors duration-75 shadow-sm disabled:cursor-not-allowed focus:outline-none focus-visible:ring [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        primary:
          'bg-primary-600 text-white border border-primary-700 hover:bg-primary-800 hover:text-white active:bg-primary-950 disabled:bg-primary-900 focus-visible:ring-primary-800',
        secondary:
          'bg-primary-400 text-white border border-primary-500 hover:bg-primary-500 hover:text-white active:bg-primary-700 disabled:bg-primary-700 focus-visible:ring-primary-500',
        outline:
